...
const Announcement = () => {
  return (
    <div className=" absolute font2 bottom-0 bg-black bg-transparent  font2 flex justify-between  text-white text-xs lg:text-sm items-center py-3 px-2">
        ...
        <div className=" flex gap-8 mr-4">
          ...
          <div className="flex items-center gap-1">
            <img
              ...
              width={18}
            />
            <p className=" font-medium">BTC:$69,697.94</p>
          </div>
          ...
          <div className="flex items-center gap-1">
            <img
              ...
              width={18}
            />
            <p className=" font-medium">ETH:$3,551.94</p>
          </div>
          ...
          <div className="flex items-center gap-1">
            <img
              ...
              width={18}
            />
            <p className=" font-medium">USDT:$1.00</p>
          </div>
        </div>
      </Marquee>
    </div>
