    ...
    <footer className=" bg-black text-white   py-10 flex justify-center items-center font2">
      <div className=" w-[90%] mx-auto ">
        <div className="lg:flex justify-between">
          <h3 className=" text-sm lg:w-[15%] mb-8 lg:mb-0 text-yellow-500 uppercase ">
          ...
          <div className="lg: w-[80%] flex gap-6 flex-col lg:flex-row justify-between">
            {footer.map((item) => {
              return (
                <div key={item.title}>
                  <h2 className=" text-yellow-600  font-semibold mb-4">
                    {item.title}
                  </h2>
                  ...
                  {item.list.map((l, index) => (
                    <p
                      key={index}
                      className=" text-sm text-gray-500 font-medium mb-2.5 hover:text-black hover:font-semibold"
                    >
                      {l}
                    </p>
                  ))}
